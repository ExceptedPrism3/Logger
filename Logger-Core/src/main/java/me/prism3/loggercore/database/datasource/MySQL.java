...
public final class MySQL extends AbstractDataSource {
    ...
    public void createTables() {
        ...
        try (final Connection connection = this.getConnection();
            ...
            statement.executeUpdate("CREATE TABLE IF NOT EXISTS server_address(id INTEGER PRIMARY KEY AUTO_INCREMENT," +
                    "server_name TEXT, player_name TEXT NOT NULL, player_uuid TEXT NOT NULL, date DATETIME NOT NULL," +
                    " domain TEXT)");

            statement.executeUpdate("CREATE TABLE IF NOT EXISTS armorstand_interaction(id INTEGER PRIMARY KEY AUTO_INCREMENT," +
                    " server_name TEXT," +
            ...
            statement.executeUpdate("CREATE TABLE IF NOT EXISTS armorstand_endcrystal(id INTEGER PRIMARY KEY AUTO_INCREMENT," +
                    " server_name TEXT," +
                    " player_name TEXT NOT NULL," +
                    " player_uuid TEXT NOT NULL," +
                    " date DATETIME NOT NULL," +
            ...
            statement.executeUpdate("CREATE TABLE IF NOT EXISTS lever_interaction (id INTEGER PRIMARY KEY AUTO_INCREMENT," +
                    " date DATETIME NOT NULL," +
                    " server_name TEXT," +
                    " world TEXT NOT NULL," +
                    " player_uuid TEXT NOT NULL," +
            ...
            if (this.options.isEssentialsEnabled())
                statement.executeUpdate("CREATE TABLE IF NOT EXISTS afk(id INTEGER PRIMARY KEY AUTO_INCREMENT," +
                                " server_name TEXT, date DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, world TEXT," +
                                " player_name TEXT, x INTEGER, y INTEGER, z INTEGER, is_staff BOOLEAN)");

            if (this.options.isAuthMeEnabled())
                statement.executeUpdate("CREATE TABLE IF NOT EXISTS wrong_password(id INTEGER PRIMARY KEY AUTO_INCREMENT," +
                                " server_name TEXT, date DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, world TEXT," +
                                "player_name TEXT, is_staff BOOLEAN)");

            if (this.options.isVaultEnabled())
                statement.executeUpdate("CREATE TABLE IF NOT EXISTS vault(id INTEGER PRIMARY KEY AUTO_INCREMENT," +
            ...
            if (this.options.isViaVersion())
                statement.executeUpdate("CREATE TABLE IF NOT EXISTS wood_stripping (id INTEGER PRIMARY KEY AUTO_INCREMENT," +
                                " server_name TEXT, date DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, world TEXT, " +
