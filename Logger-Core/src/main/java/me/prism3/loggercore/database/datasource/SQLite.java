...
public final class SQLite extends AbstractDataSource {
    ...
    public SQLite(Options options, File dataFolder, String prefix) {

        super(options, SQLite.class.getName(), prefix);
    ...
    public void createTables() {
        ...
        try (final Connection connection = this.getConnection();
            ...
            statement.executeUpdate("CREATE TABLE IF NOT EXISTS "+this.prefix+"_server_address(id INTEGER PRIMARY KEY AUTOINCREMENT," +
                    "server_name TEXT, player_name TEXT NOT NULL, player_uuid TEXT NOT NULL, date DATETIME NOT NULL," +
                    " domain TEXT)");

            statement.executeUpdate("CREATE TABLE IF NOT EXISTS "+this.prefix+"_armorstand_interaction(id INTEGER PRIMARY KEY AUTOINCREMENT," +
                    " server_name TEXT," +
            ...
            statement.executeUpdate("CREATE TABLE IF NOT EXISTS "+this.prefix+"_armorstand_endcrystal(id INTEGER PRIMARY KEY AUTOINCREMENT," +
                    " server_name TEXT," +
                    " player_name TEXT NOT NULL," +
                    " player_uuid TEXT NOT NULL," +
                    " date DATETIME NOT NULL," +
            ...
            statement.executeUpdate("CREATE TABLE IF NOT EXISTS "+this.prefix+"_lever_interaction (id INTEGER PRIMARY KEY AUTOINCREMENT," +
                    " date DATETIME NOT NULL," +
                    " server_name TEXT," +
                    " world TEXT NOT NULL," +
                    " player_uuid TEXT NOT NULL," +
            ...
            if (this.options.isEssentialsEnabled())
                statement.executeUpdate("CREATE TABLE IF NOT EXISTS "+this.prefix+"_afk(id INTEGER PRIMARY KEY AUTOINCREMENT," +
                                " server_name TEXT, date DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, world TEXT," +
                                " player_name TEXT, x INTEGER, y INTEGER, z INTEGER, is_staff BOOLEAN)");

            if (this.options.isAuthMeEnabled())
                statement.executeUpdate("CREATE TABLE IF NOT EXISTS "+this.prefix+"_wrong_password(id INTEGER PRIMARY KEY AUTOINCREMENT," +
                                " server_name TEXT, date DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, world TEXT," +
                                "player_name TEXT, is_staff BOOLEAN)");

            if (this.options.isVaultEnabled())
                statement.executeUpdate("CREATE TABLE IF NOT EXISTS "+this.prefix+"_vault(id INTEGER PRIMARY KEY AUTOINCREMENT," +
            ...
            if (this.options.isViaVersion())
                statement.executeUpdate("CREATE TABLE IF NOT EXISTS "+this.prefix+"_wood_stripping (id INTEGER PRIMARY KEY AUTOINCREMENT," +
                                " server_name TEXT, date DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, world TEXT, " +
