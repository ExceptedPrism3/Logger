	...
	public void connect() {
		...
		if (!isConnected()) {
			...
			try {
				...
				logger.warning("Could not connect to the PostgreSQL Database!");
	...
	public void disconnect() {
		...
		if (isConnected()) {
			...
			try {
				...
				logger.warning("PostgreSQL Database couldn't be closed safely, if the issue persists contact the Authors!");
