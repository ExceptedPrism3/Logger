...
public class SQLiteData<T extends SQLiteTemplate> {
    ...
    public SQLiteData(T t, Configuration configuration) {
    ...
    public static void insertPlayerChat(String serverName, Player player, String message, boolean staff) {
        ...
        try {
            PreparedStatement playerChat = sqLite.getConnection().prepareStatement("INSERT INTO Player_Chat (Server_Name,Date, World, Player_Name, Message, Is_Staff) VALUES (?,?,?,?,?,?)");
    ...
    public static void insertPlayerCommands(String serverName, Player player, String command, boolean staff) {
        try {
            PreparedStatement playerCommands = sqLite.getConnection().prepareStatement("INSERT INTO Player_Commands(Server_Name,Date, World, Player_Name, Command, Is_Staff) VALUES (?,?,?,?,?,?)");
    ...
    public static void insertConsoleCommands(String servername, String commanmd) {
        try {
            PreparedStatement consoleCommands = sqLite.getConnection().prepareStatement("INSERT INTO Console_Commands(Server_Name, Date, Command) VALUES (?,?,?)");
    ...
    public static void insertPlayerSignText(String serverName, Player player, String lines, boolean isStaff) {
        try {
            PreparedStatement playerSignText = sqLite.getConnection().prepareStatement("INSERT INTO Player_Sign_Text(Server_Name, Date, World, X, Y, Z, Player_Name, Line, Is_Staff) VALUES (?,?,?,?,?,?,?,?,?)");
    ...
    public static void insertPlayerDeath(String serverName, Player player, String cause, String by_who, String using, boolean isStaff) {
        try {
            PreparedStatement playerDeath = sqLite.getConnection().prepareStatement("INSERT INTO Player_Death(Server_Name, Date, World, Player_Name, X, Y, Z, Cause, By_Who, Item_Used, Is_Staff) VALUES (?,?,?,?,?,?,?,?,?,?,?)");
    ...
    public static void insertPlayerTeleport(String serverName, Player player, Location from, Location to, boolean isStaff) {
        try {
            PreparedStatement playerTeleport = sqLite.getConnection().prepareStatement("INSERT INTO Player_Teleport(Server_Name, Date, World, Player_Name, From_X, From_Y, From_Z, To_X, To_Y, To_Z, Is_Staff) VALUES (?,?,?,?,?,?,?,?,?,?,?)");
    ...
    public static void insertPlayerJoin(String serverName, Player player, boolean isStaff) {
        try {
            PreparedStatement playerJoin = sqLite.getConnection().prepareStatement("INSERT INTO Player_Join(Server_Name, World, X, Y, Z, IP, Is_Staff) VALUES (?,?,?,?,?,?,?)");
    ...
    public static void insertPlayerLeave(String serverName, Player player, boolean isStaff) {
        try {
            PreparedStatement playerLeave = sqLite.getConnection().prepareStatement("INSERT INTO Player_Leave(Server_Name, Date, World, X, Y, Z, Player_Name, Is_Staff) VALUES (?,?,?,?,?,?,?,?)");
    ...
    public static void insertBlockPlace(String serverName, Player player, Material block, boolean isStaff) {
        try {
            PreparedStatement blockPlace = sqLite.getConnection().prepareStatement("INSERT INTO Block_Place(Server_Name, Date, World, Player_Name,Block, X, Y, Z, Is_Staff) VALUES (?,?,?,?,?,?,?,?,?)");
    ...
    public static void insertBlockBreak(String serverName, Player player, Material block, boolean isStaff) {
        try {
            PreparedStatement blockBreak = sqLite.getConnection().prepareStatement("INSERT INTO Block_Break(Server_Name, Date, World, Player_Name, Block, X, Y, Z, Is_Staff) VALUES (?,?,?,?,?,?,?,?,?)");
    ...
    public static void insertRAM(String serverName, long totalMemory, long usedMemory, long freeMemory) {
        try {
            PreparedStatement ramStatement = sqLite.getConnection().prepareStatement("INSERT INTO RAM(Server_Name, Date, Total_Memory, Used_Memory, Free_Memory) VALUES (?,?,?,?,?)");
    ...
    public static void insertPlayerKick(String serverName, Player player, String reason, boolean isStaff) {
        try {
            PreparedStatement playerKickStatement = sqLite.getConnection().prepareStatement("INSERT INTO Player_Kick(Server_Name, Date, World, Player_Name, X, Y, Z, Reason, Is_Staff) VALUES (?,?,?,?,?,?,?,?,?)");
    ...
    public static void insertPortalCreate(String serverName, String worldName, PortalCreateEvent.CreateReason reason) {
        try {
            PreparedStatement portalCreateStatement = sqLite.getConnection().prepareStatement("INSERT INTO Portal_Creation(Server_Name, Date, World, Caused_By) VALUES (?,?,?,?)");
    ...
    public static void insertLevelChange(String serverName, Player player, boolean isStaff) {
        try {
            PreparedStatement levelChangeStatement = sqLite.getConnection().prepareStatement("INSERT INTO Player_Level(Server_Name, Date, Player_Name, Is_Staff) VALUES (?,?,?,?)");
    ...
    public static void insertBucketPlace(String serverName, Player player, String bucket, boolean isStaff) {
        try {
            PreparedStatement bucketPlaceStatement = sqLite.getConnection().prepareStatement("INSERT INTO Bucket_Place(Server_Name, Date, World, Player_Name, Bucket, X, Y, Z, Is_Staff) VALUES (?,?,?,?,?,?,?,?,?)");
    ...
    public static void insertAnvil(String serverName, Player player, String newName, boolean isStaff) {
        try {
            PreparedStatement anvilStatement = sqLite.getConnection().prepareStatement("INSERT INTO Anvil(Server_Name, Date, Player_Name,  New_Name, Is_Staff) VALUES (?,?,?,?,?)");
    ...
    public static void insertItemDrop(String serverName, Player player, String item, int amount, int x, int y, int z, List<String> enchantment, String changedName, boolean isStaff) {
        try {
            PreparedStatement itemDropStatement = sqLite.getConnection().prepareStatement("INSERT INTO Item_Drop(Server_Name, Date, World, Player_Name, Item, Amount, X, Y, Z, Enchantment, Changed_Name, Is_Staff) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)");
    ...
    public static void insertEnchant(String serverName, Player player, List<String> enchantment, String item, int cost, boolean isStaff) {
        try {
            PreparedStatement enchantStatement = sqLite.getConnection().prepareStatement("INSERT INTO Enchanting(Server_Name, Date, World, Player_Name, X, Y, Z, Enchantment, Item, Cost, Is_Staff) VALUES (?,?,?,?,?,?,?,?,?,?,?)");
    ...
    public static void insertBook(String serverName, String world, Player playername, int pages, List<String> content, String signed_by, boolean staff) {
        try {
            PreparedStatement book_editing = sqLite.getConnection().prepareStatement("INSERT  INTO Book_Editing(Server_Name, Date, World, Player_Name, Page_Count, Page_Content, Signed_by, Is_Staff) VALUES(?,?,?,?,?,?,?,?)");
    ...
    public static void insertAFK(String serverName, Player player, boolean isStaff) {
        ...
        if (api != null) {
            ...
            try {
                PreparedStatement enchantStatement = sqLite.getConnection().prepareStatement("INSERT INTO AFK (Server_Name, Date, World, Player_Name, X, Y, Z, Is_Staff) VALUES (?,?,?,?,?,?,?,?)");
                enchantStatement.setString(1, serverName);
                enchantStatement.setString(2, dateTimeFormatter.format(ZonedDateTime.now()));
                enchantStatement.setString(3, player.getWorld().getName());
                enchantStatement.setString(4, player.getName());
    ...
    public static void insertItemPickup(String serverName, Player player, Material item, int amount, int x, int y, int z, String changed_name, boolean isStaff) {
        try {
            PreparedStatement itemPickupStatement = sqLite.getConnection().prepareStatement("INSERT INTO Item_Pickup(Server_Name, Date, World, Player_Name, Item, Amount, X, Y, Z, Changed_Name, Is_Staff) VALUES (?,?,?,?,?,?,?,?,?,?,?)");
    ...
    public static void insertFurnace(String serverName, Player player, Material item, int amount, int x, int y, int z, boolean isStaff) {
        try {
            PreparedStatement furnaceStatement = sqLite.getConnection().prepareStatement("INSERT INTO Furnace(Server_Name, Date, World, Player_Name, Item, Amount, X, Y, Z, Is_Staff) VALUES (?,?,?,?,?,?,?,?,?,?)");
    ...
    public void emptyTable() {
        ...
        try {
            ...
            PreparedStatement player_Chat = sqLite.getConnection().prepareStatement("DELETE FROM Player_Chat WHERE Date <= datetime('now','-" + when + " day')");

            PreparedStatement player_Commands = sqLite.getConnection().prepareStatement("DELETE FROM Player_Commands WHERE Date <= datetime('now','-" + when + " day')");

            PreparedStatement console_Commands = sqLite.getConnection().prepareStatement("DELETE FROM Console_Commands WHERE Date <= datetime('now','-" + when + " day')");

            PreparedStatement player_Sign_Text = sqLite.getConnection().prepareStatement("DELETE FROM Player_Sign_Text WHERE Date <= datetime('now','-" + when + " day')");

            PreparedStatement player_Join = sqLite.getConnection().prepareStatement("DELETE FROM Player_Join WHERE Date <= datetime('now','-" + when + " day')");

            PreparedStatement player_Leave = sqLite.getConnection().prepareStatement("DELETE FROM Player_Leave WHERE Date <= datetime('now','-" + when + " day')");

            PreparedStatement player_Kick = sqLite.getConnection().prepareStatement("DELETE FROM Player_Kick WHERE Date <= datetime('now','-" + when + " day')");

            PreparedStatement player_Death = sqLite.getConnection().prepareStatement("DELETE FROM Player_Death WHERE Date <= datetime('now','-" + when + " day')");

            PreparedStatement player_Teleport = sqLite.getConnection().prepareStatement("DELETE FROM Player_Teleport WHERE Date <= datetime('now','-" + when + " day')");

            PreparedStatement player_Level = sqLite.getConnection().prepareStatement("DELETE FROM Player_Level WHERE Date <= datetime('now','-" + when + " day')");

            PreparedStatement block_Place = sqLite.getConnection().prepareStatement("DELETE FROM Block_Place WHERE Date <= datetime('now','-" + when + " day')");

            PreparedStatement block_Break = sqLite.getConnection().prepareStatement("DELETE FROM Block_Break WHERE Date <= datetime('now','-" + when + " day')");

            PreparedStatement portal_Creation = sqLite.getConnection().prepareStatement("DELETE FROM Portal_Creation WHERE Date <= datetime('now','-" + when + " day')");

            PreparedStatement bucket_Place = sqLite.getConnection().prepareStatement("DELETE FROM Bucket_Place WHERE Date <= datetime('now','-" + when + " day')");
            ...
            PreparedStatement server_Start = sqLite.getConnection().prepareStatement("DELETE FROM Server_Start WHERE Date <= datetime('now','-" + when + " day')");

            PreparedStatement server_Stop = sqLite.getConnection().prepareStatement("DELETE FROM Server_Stop WHERE Date <= datetime('now','-" + when + " day')");
            ...
            PreparedStatement book_Editing = sqLite.getConnection().prepareStatement("DELETE FROM Book_Editing WHERE Date <= datetime('now','-" + when + " day')");
            ...
            PreparedStatement item_pickup = sqLite.getConnection().prepareStatement("DELETE FROM Item_Pickup WHERE Date <= datetime('now','-" + when + " day')");
