...
public class MySQLData {
  ...
  public void createTable() {
    ...
    try {
      ...
      playerCommands = mySQL.getConnection()
      ...
      consoleCommands = mySQL.getConnection()
      ...
      playerSignText = mySQL.getConnection()
      ...
      playerDeath = mySQL.getConnection()
      ...
      playerTeleport = mySQL.getConnection()
      ...
      playerLeave = mySQL.getConnection()
      ...
      portalCreation = mySQL.getConnection()
      ...
      playerLevel = mySQL.getConnection()
      ...
      bucketPlace = mySQL.getConnection()
      ...
      serverStart = mySQL.getConnection()
      ...
      bookEditing = mySQL.getConnection()
  ...
  public void playerChat(String serverName, String worldName, String playerName, String msg,
      boolean staff) {
    try {
      String database = "Player_Chat";
      PreparedStatement playerChat = mySQL.getConnection()
          .prepareStatement("INSERT IGNORE INTO " + database
  ...
  public void playerCommands(String serverName, String worldName, String playerName, String msg,
      boolean staff) {
    try {
  ...
  public void consoleCommands(String serverName, String msg) {
    try {
      ...
      PreparedStatement consoleCommands = mySQL.getConnection()
          .prepareStatement("INSERT IGNORE INTO " + database + "(Server_Name,Command) VALUES(?,?)");
  ...
  public void playerSignText(String serverName, String worldName, double x, double y, double z,
  ...
  public void playerDeath(String serverName, String worldName, String playerName, double x,
      double y, double z, String cause, String who,
    ...
    try {
      ...
      PreparedStatement playerDeath = mySQL.getConnection().prepareStatement(
          "INSERT IGNORE INTO " + database
              + "(Server_Name,World,Playername,X,Y,Z,Cause,By_Who,Item_Used,Is_Staff) VALUES(?,?,?,?,?,?,?,?,?,?)");
  ...
  public void playerTeleport(String serverName, String worldName, String playerName, double ox,
      double oy, double oz, double tx, double ty, double tz,
      boolean staff) {
    try {
  ...
  public void playerJoin(String serverName, String worldName, String playerName, double x, double y,
      double z, InetSocketAddress IP, boolean staff) {
    try {
  ...
  public void playerLeave(String serverName, String worldName, String playerName, double x,
  ...
  public void blockPlace(String serverName, String worldName, String playerName, String block,
  ...
  public void blockBreak(String serverName, String worldName, String playerName, String blockname,
      double x, double y, double z, boolean staff) {
    try {
  ...
  public void TPS(String serverName, double tps) {
    try {
      String database = "TPS";
      PreparedStatement TPS = mySQL.getConnection()
          .prepareStatement("INSERT IGNORE INTO " + database + "(Server_Name,TPS) VALUES(?,?)");
  ...
  public void playerKick(String serverName, String worldName, String playerName, double x, double y,
      double z, String reason, boolean staff) {
    try {
  ...
  public void portalCreate(String serverName, String worldName, String portalCreateReason) {
    try {
      ...
      PreparedStatement portalCreation = mySQL.getConnection()
          .prepareStatement(
              "INSERT IGNORE INTO " + database + "(Server_Name,World,Caused_By) VALUES(?,?,?)");
  ...
  public void levelChange(String serverName, String playerName, boolean staff) {
    try {
      ...
      PreparedStatement playerLevel = mySQL.getConnection()
          .prepareStatement(
              "INSERT IGNORE INTO " + database + "(Server_Name,Playername,Is_Staff) VALUES(?,?,?)");
  ...
  public void bucketPlace(String serverName, String worldName, String playerName, String bucket,
      double x, double y, double z, boolean staff) {
    try {
  ...
  public void serverStart(String serverName) {
    try {
      ...
      PreparedStatement serverStart = mySQL.getConnection()
          .prepareStatement("INSERT IGNORE INTO " + database + "(Server_Name) VALUES(?)");
  ...
  public void serverStop(String serverName) {
    try {
      ...
      PreparedStatement serverStop = mySQL.getConnection()
          .prepareStatement("INSERT IGNORE INTO " + database + "(Server_Name) VALUES(?)");
  ...
  public void itemDrop(String serverName, String world, String playerName, String item, int amount,
      int x, int y, int z, List<String> enchantment,
      String changedName, boolean staff) {
    try {
      String database = "Item_Drop";
      PreparedStatement itemDrop = mySQL.getConnection()
          .prepareStatement("INSERT IGNORE INTO " + database
  ...
  public void enchant(String serverName, String world, String playerName, double x, double y,
      double z, List<String> enchantment, String item,
      int cost, boolean staff) {
    try {
      String database = "Enchanting";
      PreparedStatement enchanting = mySQL.getConnection().prepareStatement(
          "INSERT IGNORE INTO " + database
              + "(Server_Name,World,Playername,X,Y,Z,Enchantment,Item,Cost,Is_Staff) VALUES(?,?,?,?,?,?,?,?,?,?)");
  ...
  public void bookEditing(String serverName, String world, String playerName, int pages,
      List<String> content, String signed_by, boolean staff) {
    try {
      String database = "Book_Editing";
      PreparedStatement enchanting = mySQL.getConnection().prepareStatement(
          "INSERT IGNORE INTO " + database
              + "(Server_Name,World,Playername,Page_Count,Page_Content,Signed_by,Is_Staff) VALUES(?,?,?,?,?,?,?)");
      enchanting.setString(1, serverName);
      enchanting.setString(2, world);
      enchanting.setString(3, playerName);
  ...
  public void afk(String serverName, String world, String playerName, double x, double y, double z,
      boolean staff) {
  ...
  public void itemPickup(String serverName, String world, String playerName, String item,
    ...
    try {
      ...
      PreparedStatement itemPickup = mySQL.getConnection().prepareStatement(
          "INSERT IGNORE INTO " + database
              + "(Server_Name,World,Playername,Item,Amount,X,Y,Z,Changed_Name,Is_Staff) VALUES(?,?,?,?,?,?,?,?,?,?)");
  ...
  public void furnace(String serverName, String world, String playerName, String item, int amount,
      double x, double y, double z, boolean staff) {
    try {
  ...
  public void emptyTable() {
    ...
    try {
      ...
      PreparedStatement playerChat = mySQL.getConnection().prepareStatement(
      ...
      PreparedStatement playerJoin = mySQL.getConnection().prepareStatement(
          "DELETE FROM Player_Join WHERE DATE < NOW() - INTERVAL " + when + " DAY");

      PreparedStatement playerLeave = mySQL.getConnection().prepareStatement(
          "DELETE FROM Player_Leave WHERE Date < NOW() - INTERVAL " + when + " DAY");

      PreparedStatement playerKick = mySQL.getConnection().prepareStatement(
      ...
      PreparedStatement playerLevel = mySQL.getConnection().prepareStatement(
          "DELETE FROM Player_Level WHERE Date < NOW() - INTERVAL " + when + " DAY");

      PreparedStatement blockPlace = mySQL.getConnection().prepareStatement(
          "DELETE FROM Block_Place WHERE DATE < NOW() - INTERVAL " + when + " DAY");

      PreparedStatement blockBreak = mySQL.getConnection().prepareStatement(
      ...
      PreparedStatement bucketPlace = mySQL.getConnection().prepareStatement(
      ...
      PreparedStatement serverStart = mySQL.getConnection().prepareStatement(
          "DELETE FROM Server_Start WHERE Date < NOW() - INTERVAL " + when + " DAY");

      PreparedStatement serverStop = mySQL.getConnection().prepareStatement(
          "DELETE FROM Server_Stop WHERE DATE < NOW() - INTERVAL " + when + " DAY");

      PreparedStatement itemDrop = mySQL.getConnection()
          .prepareStatement("DELETE FROM Item_Drop WHERE Date < NOW() - INTERVAL " + when + " DAY");

      PreparedStatement enchanting = mySQL.getConnection().prepareStatement(
          "DELETE FROM Enchanting WHERE DATE < NOW() - INTERVAL " + when + " DAY");

      PreparedStatement bookEditing = mySQL.getConnection().prepareStatement(
