        ...
        if (!event.isCancelled() && this.main.getConfig().getBoolean("Log-Player.Sign-Text")) {
            ...
            if (Data.isLogToFiles) {
                ...
                if (Data.isStaffEnabled && player.hasPermission(Data.loggerStaffLog)) {
                    ...
                    if (Data.isExternal && this.main.getExternal().isConnected()) {
                        ...
                        ExternalData.playerSignText(Data.serverName, worldName, x, y, z, playerName, "[" + lines.get(0) + "] " + "[" + lines.get(1) + "] " + "[" + lines.get(2) + "] " + "[" + lines.get(3) + "]", true);
            ...
            if (Data.isExternal && this.main.getExternal().isConnected()) {
                ...
                try {
                    ...
                    ExternalData.playerSignText(Data.serverName, worldName, x, y, z, playerName, "[" + lines.get(0) + "] " + "[" + lines.get(1) + "] " + "[" + lines.get(2) + "] " + "[" + lines.get(3) + "]", player.hasPermission(Data.loggerStaffLog));
