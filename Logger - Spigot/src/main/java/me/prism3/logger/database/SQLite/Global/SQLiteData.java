...
public class SQLiteData {
    ...
    public void createTable() {
        ...
        final PreparedStatement playerChat, playerCommands, consoleCommands, playerSignText, playerJoin, playerLeave,
                ...
                wrongPassword, itemPickup, furnace, rcon, gameMode, craft, vault, registration, primedTNT, spawnEgg,liteBans,
        ...
        try {
            ...
            if (plugin.getVersion().isAtLeast(NmsVersions.v1_13_R1)) {
                ...
                woodStripping = plugin.getSqLite().getConnection().prepareStatement("CREATE TABLE IF NOT EXISTS wood_stripping" +
                        ...
                        "uuid TEXT(100), player_name TEXT(40), log_name TEXT(50), x INTEGER, y INTEGER, z INTEGER, is_staff INTEGER)");
    ...
    public static void insertGameMode(String serverName, Player player, String gameMode, boolean staff) {
        try {
            ...
            game_Mode.setString(3, player.getWorld().toString());
            game_Mode.setString(4, player.getName());
    ...
    public static void insertAdvancedBan(String serverName, String executor, String executed_on, String type, String reason, long expirationDate) {
        try {
            ...
            advancedBan.setString(5, executed_on);
    ...
    public static void insertWoodStripping(String serverName, Player player, String logName, int x, int y, int z, boolean isStaff) {
        try {
            final PreparedStatement woodStrippingStatement = plugin.getSqLite().getConnection().prepareStatement("INSERT INTO wood_stripping (server_name, date, world, uuid, player_name, log_name, x, y, z, is_staff) VALUES (?,?,?,?,?,?,?,?,?,?)");
    ...
    public void emptyTable() {
        ...
        try{
            ...
            final PreparedStatement player_Commands = plugin.getSqLite().getConnection().prepareStatement("DELETE FROM player_commands WHERE date <= datetime('now','-" + sqliteDataDel + " day')");

            final PreparedStatement player_Sign_Text = plugin.getSqLite().getConnection().prepareStatement("DELETE FROM player_sign_text WHERE date <= datetime('now','-" + sqliteDataDel + " day')");

            final PreparedStatement player_Join = plugin.getSqLite().getConnection().prepareStatement("DELETE FROM player_join WHERE date <= datetime('now','-" + sqliteDataDel + " day')");

            final PreparedStatement player_Leave = plugin.getSqLite().getConnection().prepareStatement("DELETE FROM player_leave WHERE date <= datetime('now','-" + sqliteDataDel + " day')");

            final PreparedStatement player_Kick = plugin.getSqLite().getConnection().prepareStatement("DELETE FROM player_kick WHERE date <= datetime('now','-" + sqliteDataDel + " day')");

            final PreparedStatement player_Death = plugin.getSqLite().getConnection().prepareStatement("DELETE FROM player_death WHERE date <= datetime('now','-" + sqliteDataDel + " day')");

            final PreparedStatement player_Teleport = plugin.getSqLite().getConnection().prepareStatement("DELETE FROM player_teleport WHERE date <= datetime('now','-" + sqliteDataDel + " day')");

            final PreparedStatement player_Level = plugin.getSqLite().getConnection().prepareStatement("DELETE FROM player_level WHERE date <= datetime('now','-" + sqliteDataDel + " day')");

            final PreparedStatement block_Place = plugin.getSqLite().getConnection().prepareStatement("DELETE FROM block_place WHERE date <= datetime('now','-" + sqliteDataDel + " day')");

            final PreparedStatement block_Break = plugin.getSqLite().getConnection().prepareStatement("DELETE FROM block_break WHERE date <= datetime('now','-" + sqliteDataDel + " day')");

            final PreparedStatement bucket_Fill = plugin.getSqLite().getConnection().prepareStatement("DELETE FROM bucket_fill WHERE date <= datetime('now','-" + sqliteDataDel + " day')");

            final PreparedStatement bucket_Empty = plugin.getSqLite().getConnection().prepareStatement("DELETE FROM bucket_empty WHERE date <= datetime('now','-" + sqliteDataDel + " day')");
            ...
            final PreparedStatement item_Drop = plugin.getSqLite().getConnection().prepareStatement("DELETE FROM item_drop WHERE date <= datetime('now','-" + sqliteDataDel + " day')");
            ...
            final PreparedStatement book_Editing = plugin.getSqLite().getConnection().prepareStatement("DELETE FROM book_editing WHERE date <= datetime('now','-" + sqliteDataDel + " day')");

            final PreparedStatement item_pickup = plugin.getSqLite().getConnection().prepareStatement("DELETE FROM item_pickup WHERE date <= datetime('now','-" + sqliteDataDel + " day')");
            ...
            // Server Side Part
            final PreparedStatement server_Start = plugin.getSqLite().getConnection().prepareStatement("DELETE FROM server_start WHERE date <= datetime('now','-" + sqliteDataDel + " day')");

            final PreparedStatement server_Stop = plugin.getSqLite().getConnection().prepareStatement("DELETE FROM server_stop WHERE date <= datetime('now','-" + sqliteDataDel + " day')");

            final PreparedStatement console_Commands = plugin.getSqLite().getConnection().prepareStatement("DELETE FROM console_commands WHERE date <= datetime('now','-" + sqliteDataDel + " day')");
            ...
            final PreparedStatement portal_Creation = plugin.getSqLite().getConnection().prepareStatement("DELETE FROM portal_creation WHERE date <= datetime('now','-" + sqliteDataDel + " day')");
            ...
            if (AuthMeUtil.getAuthMeAPI() != null) {
                ...
                final PreparedStatement wrong_Password = plugin.getSqLite().getConnection().prepareStatement("DELETE FROM wrong_password WHERE date <= datetime('now','-" + sqliteDataDel + " day')");
