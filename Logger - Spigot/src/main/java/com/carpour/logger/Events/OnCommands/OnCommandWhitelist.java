                ...
                if (commandParts.get(0).equalsIgnoreCase(m)) {
                    ...
                    if (main.getConfig().getBoolean("Log-to-Files")) {
                        ...
                        if (main.getConfig().getBoolean("Staff.Enabled") && player.hasPermission("logger.staff.log")) {
                            ...
                            if (!Objects.requireNonNull(Messages.get().getString("Discord.Player-Commands-Whitelisted-Staff")).isEmpty()) {
                                ...
                                Discord.staffChat(player, Objects.requireNonNull(Messages.get().getString("Discord.Player-Commands-Whitelisted-Staff")).replaceAll("%time%", dateFormat.format(date)).replaceAll("%world%", worldName).replaceAll("%command%", command), false);
                    ...
                    if (main.getConfig().getBoolean("Staff.Enabled") && player.hasPermission("logger.staff.log")) {
                        ...
                        if (!Objects.requireNonNull(Messages.get().getString("Discord.Player-Commands-Whitelisted-Staff")).isEmpty()) {
                            ...
                            Discord.staffChat(player, Objects.requireNonNull(Messages.get().getString("Discord.Player-Commands-Staff-Whitelisted")).replaceAll("%time%", dateFormat.format(date)).replaceAll("%world%", worldName).replaceAll("%command%", command), false);
                        ...
                        if (!Objects.requireNonNull(Messages.get().getString("Discord.Player-Commands-Whitelisted")).isEmpty()) {
                            ...
                            Discord.playerCommand(player, Objects.requireNonNull(Messages.get().getString("Discord.Player-Commands-Whitelisted")).replaceAll("%time%", dateFormat.format(date)).replaceAll("%world%", worldName).replaceAll("%command%", command), false);
                        }
                    }
