        ...
        if (!event.isCancelled() && this.main.getConfig().getBoolean("Log-Player.Block-Place")) {
            ...
            if (isExternal && this.main.getExternal().isConnected()) {
                ...
                try {
                    ...
                    ExternalData.blockPlace(serverName, worldName, playerName, blockType.toString(), x, y, z, player.hasPermission(loggerStaffLog));
            ...
            if (isSqlite && this.main.getSqLite().isConnected()) {
                ...
                try {
                    ...
                    SQLiteData.insertBlockPlace(serverName, player, blockType, player.hasPermission(loggerStaffLog));
