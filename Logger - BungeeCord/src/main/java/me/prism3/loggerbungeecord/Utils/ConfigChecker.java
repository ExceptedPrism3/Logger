...
public class ConfigChecker {
    ...
    public ConfigChecker() {
        ...
        if (confVer.length != 3) {
            ...
            this.isGood = false;
            Main.getInstance().getLogger().severe("Invalid Config Version " + Arrays.toString(confVer) + ". This might be due to an outdated config file");
            Main.getInstance().getLogger().severe("Disabling...");
            return;
        }
