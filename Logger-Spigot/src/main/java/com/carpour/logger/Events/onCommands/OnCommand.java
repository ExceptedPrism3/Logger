    ...
    if (!event.isCancelled() && main.getConfig().getBoolean("Log.Player-Commands")) {
      ...
      if (main.getConfig().getBoolean("Log-to-Files")) {
        ...
        if (main.getConfig().getBoolean("Staff.Enabled")
          ...
          main.getDiscord()
              .sendStaffChat(
                  playerName,
                  player.getUniqueId(),
                  Objects.requireNonNull(Messages.get().getString("Discord.Player-Commands-Staff"))
          ...
          try {
            ...
            out.write(
                Objects.requireNonNull(Messages.get().getString("Files.Player-Commands-Staff"))
          ...
          if (main.getConfig().getBoolean("MySQL.Enable") && main.getMySQL().isConnected()) {
            ...
            main.getMySQLData().playerCommands(serverName, worldName, playerName, command, true);
          }
        ...
        try {
          ...
          out.write(
              Objects.requireNonNull(Messages.get().getString("Files.Player-Commands"))
                      .replaceAll("%time%", dateFormat.format(date))
                      .replaceAll("%world%", worldName)
                      .replaceAll("%player%", playerName)
                      .replaceAll("%command%", command)
      ...
      if (main.getConfig().getBoolean("Staff.Enabled")
        ...
        main.getDiscord()
            .sendPlayerCommand(
                playerName,
                player.getUniqueId(),
                Objects.requireNonNull(Messages.get().getString("Discord.Player-Commands"))
                    .replaceAll("%world%", worldName)
                    .replaceAll("%command%", command),
                false);
      }
      ...
      if (main.getConfig().getBoolean("MySQL.Enable") && main.getMySQL().isConnected()) {
        ...
        try {
          ...
          main.getMySQLData().playerCommands(
              serverName, worldName, playerName, command, player.hasPermission("logger.staff.log"));
      ...
      if (main.getConfig().getBoolean("SQLite.Enable") && main.getSqLite().isConnected()) {
        ...
        try {
          ...
          main.getSqLiteData().insertPlayerCommands(
              serverName, playerName,worldName, command, player.hasPermission("logger.staff.log"));
