...
public class OnItemPickup implements Listener {
  ...
  public void onItemPick(PlayerPickupItemEvent event) {
    ...
    String itemName =
        Objects.requireNonNull(event.getItem().getItemStack().getItemMeta()).getDisplayName();
        ...
        if (item.equals(Material.getMaterial(list))) {
          ...
          if (main.getConfig().getBoolean("Log-to-Files")) {
            ...
            if (main.getConfig().getBoolean("Staff.Enabled")
              ...
              Discord.staffChat(
                  player,
                  Objects.requireNonNull(Messages.get().getString("Discord.Item-Pickup-Staff"))
              ...
              try {
                ...
                out.write(
                    Objects.requireNonNull(Messages.get().getString("Files.Item-Pickup-Staff"))
            ...
            try {
              ...
              BufferedWriter out =
                  new BufferedWriter(new FileWriter(FileHandler.getItemPickupFile(), true));
              out.write(
                  Objects.requireNonNull(Messages.get().getString("Files.Item-Pickup"))
                          .replaceAll("%time%", dateFormat.format(date))
                          .replaceAll("%world%", worldName)
                          .replaceAll("%player%", playerName)
                          .replaceAll("%item%", String.valueOf(item))
          ...
          if (main.getConfig().getBoolean("Staff.Enabled")
            ...
            main.getDiscord()
                .sendItemPickup(
                    playerName,
                    player.getUniqueId(),
                    Objects.requireNonNull(Messages.get().getString("Discord.Item-Pickup"))
                        .replaceAll("%world%", worldName)
                        .replaceAll("%item%", String.valueOf(item))
                        .replaceAll("%amount%", String.valueOf(amount))
                        .replaceAll("%x%", String.valueOf(blockX))
          ...
          if (main.getConfig().getBoolean("SQLite.Enable") && main.getSqLite().isConnected()) {
            ...
            try {
              ...
              main.getSqLiteData().insertItemPickup(
                  serverName,
                  playerName,
                  worldName,
                  itemName,
