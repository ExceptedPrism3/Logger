        ...
        if (!event.isCancelled() && this.main.getConfig().getBoolean("Log-Player.Block-Place")) {
            ...
            if (Data.isLogToFiles) {
                ...
                if (Data.isStaffEnabled && player.hasPermission(loggerStaffLog)) {
                    ...
                    try {
                        ...
                        final BufferedWriter out = new BufferedWriter(new FileWriter(FileHandler.getBlockPlaceLogFile(), true));
            ...
            if (Data.isExternal) {
                ...
                try {
                    ...
                    Main.getInstance().getDatabase().insertBlockPlace(Data.serverName, entityPlayer, blockType.name(), coordinates);
            ...
            if (Data.isSqlite) {
                ...
                try {
                    ...
                    Main.getInstance().getSqLite().insertBlockPlace(Data.serverName, entityPlayer, blockType.name(), coordinates);
