            ...
            if (event.getNewGameMode() == GameMode.valueOf(gameMode.toUpperCase())) {
                ...
                if (Data.isExternal) {
                    ...
                    try {
                        ...
                        Main.getInstance().getDatabase().getDatabaseQueue().queueGameMode(Data.serverName, playerName, playerUUID.toString(), gameMode, worldName, player.hasPermission(loggerStaffLog));
