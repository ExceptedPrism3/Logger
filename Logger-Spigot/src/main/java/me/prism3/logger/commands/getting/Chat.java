...
public class Chat implements TabExecutor {
    ...
    private final DataInterface database = Main.getInstance().getDatabase();
    ...
    private static void sendResults(@NotNull CommandSender sender, @NotNull Arguments arguments,
        ...
        final Pager pager = new Pager(arguments.getTotalCount(), arguments.getHeight(), 0,
                arguments.getPage());
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, String[] args) {
        ...
        try {
            ...
            if (args.length == 0) { sender.sendMessage(command.getUsage()); }
