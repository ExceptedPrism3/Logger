...
public abstract class Updater {
	...
	private static final String[] TAGS = { "-DEV" };
	...
	protected final boolean versionCheck(final String remoteVersion) {
		...
		} catch (final NumberFormatException ex) { Log.warning("Error reading version number!"); }
	...
	public final UpdateType getType() { return this.type; }
