...
public class FileUpdater {
	...
	public static void update(final Plugin plugin, final String resourceName, final File toUpdate, final List<String> ignoredSections) throws IOException {
		...
		try(final BufferedReader newReader = new BufferedReader(new InputStreamReader(plugin.getResource(resourceName), StandardCharsets.UTF_8));
	...
	// Count spaces in front of key and divides by 2 since 1 indent = 2 spaces
