...
/**
 * The `FileHandler2` class is responsible for managing log files for different categories and handling file-based logs.
...
public class FileHandler2 {
    ...
    /**
     * Creates the player death folder structure with the Logs, Player Death, and Backups subdirectories.
     */
    private void createPlayerDeathFolder() {
        final File logsFolder = this.createFolder(LOGS_FOLDER_NAME);
        this.createFolder(logsFolder.getPath(), PLAYER_DEATH_FOLDER_NAME, BACKUPS_FOLDER_NAME);
    }
